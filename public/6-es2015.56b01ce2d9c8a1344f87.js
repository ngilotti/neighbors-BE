    ...
    class AdministradoresComponent {
        ...
        cfilter(v) {
            return this.filterUser.filter(x => x.nombre.toLowerCase().indexOf(v.toLowerCase()) !== -1 ||
                x.apellido.toLowerCase().indexOf(v.toLowerCase()) !== -1 ||
                x.email.toLowerCase().indexOf(v.toLowerCase()) !== -1 ||
                x.dni.toString().indexOf(v) !== -1);
        } // end cfilter
