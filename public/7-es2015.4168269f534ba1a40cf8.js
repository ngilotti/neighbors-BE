...
let Login2Component = /*@__PURE__*/ (() => {
    ...
    Login2Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: Login2Component, selectors: [["app-login"]], decls: 51, vars: 7, consts: [[1, "auth-wrapper", "d-flex", "no-block", "justify-content-center", "align-items-center", 2, "background", "url(assets/images/background/neighbors-login.jpg)", "height", "100%", "background-position", "center", "background-repeat", "no-repeat", "background-size", "cover"], [1, "auth-box", "on-sidebar", "m-3", "m-md-0", "neigh-color"], ["id", "loginform", 3, "ngClass"], [1, "logo"], [1, "db"], ["src", "assets/images/logo-neighbors-login.jpg", "alt", "logo"], [1, "row", "mt-4"], [1, "col-12"], ["id", "loginform", 1, "form-horizontal", "m-t-20", 3, "formGroup", "ngSubmit"], [1, "input-group", "mb-4"], [1, "input-group-prepend"], ["id", "basic-addon1", 1, "input-group-text"], [1, "ti-email"], ["type", "email", "placeholder", "example@mail.com", "aria-label", "email", "aria-describedby", "basic-addon1", "formControlName", "email", 1, "form-control"], [1, "input-group", "mb-3"], ["id", "basic-addon2", 1, "input-group-text"], [1, "ti-unlock"], ["type", "password", "placeholder", "Password", "aria-label", "Password", "aria-describedby", "basic-addon1", "formControlName", "password", 1, "form-control"], [1, "form-group", "row", "mt-4"], [1, "col-md-12"], [1, "custom-control", "custom-checkbox", "d-flex"], ["type", "checkbox", "id", "customCheck1", "formControlName", "remember", 1, "custom-control-input"], ["for", "customCheck1", 1, "custom-control-label", "font-14"], ["href", "javascript:void(0)", "id", "to-recover", 1, "text-dark", "ml-auto", "font-14", 3, "click"], [1, "fa", "fa-lock", "m-r-5"], [1, "form-group", "text-center", "mt-4"], [1, "col-xs-10", "p-b-20"], ["type", "submit", 1, "btn", "btn-info", "btn-lg", "btn-block", "text-uppercase"], ["id", "recoverform", 3, "ngClass"], [1, "btn", "btn-info", "cursor", 3, "click"], [1, "fa", "fa-arrow-left"], ["src", "assets/images/logo-icon.png", "alt", "logo"], [1, "font-medium", "m-b-20"], [1, "row", "m-t-20"], ["action", "index.html", 1, "col-12"], [1, "form-group", "row"], ["type", "email", "required", "", "placeholder", "ejemplo@gmail.com...", 1, "form-control", "form-control-lg"], ["type", "button", "name", "action", 1, "btn", "btn-block", "btn-lg", "btn-info", 3, "click"]], template: function Login2Component_Template(rf, ctx) {
            if (rf & 1) {
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_33_listener() { return ctx.showRecoverForm(); });
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](39, "Recuperar contrase\u00F1a");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](40, "span");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](41, "Ingrese su correo electr\u00F3nico para restablecer su contrase\u00F1a");
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
                ...
                _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_49_listener() { return ctx.showRecoverForm(); });
